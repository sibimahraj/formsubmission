...
import { service } from './path_to_service';  // Adjust the import as per your project structure
...
describe('service class', () => {
  ...
  describe('documentList', () => {
    it('should return a list of fields with "Yes" when uploaded_documents array is not empty', () => {
      const docResponse = [
        {
          document_list: [
            {
              ...
              document_options: [
                {
                  document_types: [
                    {
                      uploaded_documents: [{}, {}]  // Non-empty array
                    }
                  ]
                }
              ]
      ...
      const result = serviceInstance.documentList(docResponse);
    ...
    it('should return a list of fields with "No" when uploaded_documents array is empty', () => {
      const docResponse = [
        {
          document_list: [
            {
              ...
              document_options: [
                {
                  document_types: [
                    {
                      uploaded_documents: []  // Empty array
                    }
                  ]
                }
              ]
    ...
    it('should return a field with "na" when docResponse is empty', () => {
      const docResponse = [];
